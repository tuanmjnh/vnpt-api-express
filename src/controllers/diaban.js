...
module.exports.getPho = async function (req, res, next) {
  try {
    ...
    if (req.query.nhompho_id && parseInt(req.query.nhompho_id)) {
      params.nhompho_id = parseInt(req.query.nhompho_id);
    }
    if (req.query.pho_id_neo && parseInt(req.query.pho_id_neo)) {
      params.pho_id_neo = parseInt(req.query.pho_id_neo);
    }
    if (req.query.phuong_id && parseInt(req.query.phuong_id)) {
      params.phuong_id = parseInt(req.query.phuong_id);
    }
    if (req.query.loai_nv && parseInt(req.query.loai_nv)) {
      params.loai_nv = parseInt(req.query.loai_nv);
    }
